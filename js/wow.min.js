(function () {
    ...
    b = function () {
        function a() { } return a.prototype.extend = function (a, b) {
            ...
            return /Android|webOS|iPhone|iPad|IEMobile|Opera Mini/i.
                test(a)
        ...
        c = this.WeakMap || this.MozWeakMap || (c = function () {
            function a() { this.keys = [], this.values = [] } return a.prototype.get = function (a) { var b, c, d, e, f; for (f = this.keys, b = d = 0, e = f.length; e > d; b = ++d)if (c = f[b], c === a) return this.values[b] },
                a.prototype.set = function (a, b) { var c, d, e, f, g; for (g = this.keys, c = e = 0, f = g.length; f > e; c = ++e)if (d = g[c], d === a) return void (this.values[c] = b); return this.keys.push(a), this.values.push(b) }, a
        }()),
        ...
        d = this.getComputedStyle || function (a, b) {
            return this.getPropertyValue = function (b) {
                var c; return "float" === b && (b = "styleFloat"),
                    e.test(b) && b.replace(e, function (a, b) { return b.toUpperCase() }), (null != (c = a.currentStyle) ? c[b] : void 0) || null
            }, this
        },
        e = /(\-([a-z]){1})/g, this.WOW = function () {
            ...
            null == a && (a = {}), this.scrollCallback = f(this.scrollCallback, this),
                ...
                offset: 0, mobile: !0, live: !0, callback: null, scrollContainer: null
